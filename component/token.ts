...
export const TEXTCOLOR: Token = {
  default: 'var(--color-netural10)',
  brand: 'var(--color-orange60)',
  brandPrimary: 'var(--color-gray1)',
  import: 'var(--color-red60)',
  error: 'var(--color-red60)',
  label: 'var(--color-netural30)',
  labelActive: 'var(--color-netural10)',
  buttonDisabled: 'var(--color-netural80)',
  iconDefault: 'var(--color-netural50)',
  inputDisabled: 'var(--color-netural30)',
...
export const BACKGROUND: Token = {
  ...
  brand: 'var(--color-orange60)',
  inputCheckBoxDisabled: 'var(--color-netural80)',
  inputDisabled: 'var(--color-netural95)',
  notificationNew: 'var(--color-netural95)',
  rowHover: 'var(--color-netural95)',
  rowSelected: 'var(--color-netural95)',
  toast: 'var(--color-netural50)',
  toggle: 'var(--color-netural70)',
  toggleDisabled: 'var(--color-netural70)',
  toggleHover: 'var(--color-netural60)',
};
